...
if WINDOWS()
if exists('g:exvim_custom_path')
let g:exvim_folder=g:exvim_custom_path
else
let g:exvim_custom_path=$HOME
let g:exvim_folder=$HOME
endif
let g:exvim_project_name='batch'
else
let g:exvim_custom_path='~/exvim/main'
let g:exvim_project_name='batch'
let g:exvim_folder='~/exvim/main'
endif
